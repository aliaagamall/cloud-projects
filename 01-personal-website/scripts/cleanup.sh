...
echo "WARNING:"
echo "This will destroy the AWS infrastructure managed by this Terraform project."
echo
...
if [ -n "$BUCKET_NAME" ]; then
  ...
  echo
  echo "Deleting object versions and delete markers..."
...
echo "========================================"
echo
echo "The Terraform state backend was NOT deleted."
echo "State bucket: aws-cloud-projects-personal-website-tfstate"